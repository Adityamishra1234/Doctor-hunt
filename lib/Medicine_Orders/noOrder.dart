...
class NoOrderMedicine extends StatefulWidget {
  static const route = "/ProfileScreen";

  const NoOrderMedicine({Key? key}) : super(key: key);

  @override
  State<NoOrderMedicine> createState() => _NoOrderMedicineState();
}

class _NoOrderMedicineState extends State<NoOrderMedicine> {
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: AppBarHeader("Medicine Orders", () {
                ...
                child: Center(
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Image.asset("assets/images/noMedicineOrders.png", scale: 0.9,),
                        const SizedBox(height: 35,),
                        const Text("No Orders placed yet!", textAlign:TextAlign.center,style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 21,
                        ),),
                        const SizedBox(height: 10,),
                        const Text("Healing starts with a tap.", maxLines: 4,textAlign:TextAlign.center,style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: LoginButton(title: "Order Medicines", onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>const LocationServices())); //Change here the class of add records
                          },),
                        )
                      ],
                    ),
