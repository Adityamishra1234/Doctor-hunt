...
class HomeModel {
  ...
  HomeModel({required this.image, required this.categoryColor, required this.image2});
}

List<HomeModel> Homecontents = [
  HomeModel(
  ...
  HomeModel(
    ...
    image2: 'assets/images/categoryImage2.png',
    categoryColor: Color(0xff0EBE7F),
